...
In the script above I make use of the optimization function *fminsearchbnd* to generate a custom energy landscape. The author of *fminsearchbnd* is John D'Errico, who released the function 2006 on FileExchange - Mathworks (https://de.mathworks.com/matlabcentral/fileexchange/8277-fminsearchbnd-fminsearchcon?s_tid=srchtitle).
