...
<p align="center">
   <img src="https://user-images.githubusercontent.com/58071484/137738308-d6881a79-d1a1-4096-99b3-b96e57e12e9e.JPG" height=60>
</p>
...
### Simulation output
After performing the simulation, the reaction coordinate histogram (grey bars, left panel) collected from all trajectories is plotted. The similarity of the histogram with the probability density function, *p*(*x*), derived from the energy landscape, shows if the landscape is sufficently sampled, hence &#916;*t* is small enough. In the right panel the passage time histogram between *q*<sub>L</sub> and *q*<sub>R</sub> is shown. The bottom panel depicts the last state trajectory.
